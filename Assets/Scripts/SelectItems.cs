...
public class SelectItems : MonoBehaviour
{
    ...
    {
        _selectText.text = _savedItemIndex == _currentIndex ? "ÂÛÁÐÀÍÎ" : "ÂÛÁÐÀÒÜ";

        //if (_currentIndex < _items.Count)
        //{
        //    _buyButton.SetActive(_items[_currentIndex].IsPurchased == false);
        //    _buyButtonText.text = $"Öåíà: {_items[_currentIndex].Cost}$";
        //}
        //else
